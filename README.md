...
-  [Jinsi ya Kuangalia Aina za Data Bora katika JavaScript — Webbjocke](https://webbjocke.com/javascript-check-data-types/)
...
-  [JavaScript Event Loop Imeelezwa — Anoop Raveendran](https://medium.com/front-end-hacking/javascript-event-loop-explained-4cd26af121d4)
...
- [Object.assign() imeelezwa — Aaron Writes Code](https://www.youtube.com/watch?v=aw7NfYhR5rc)
...
-  [.map(), .filter(), na .reduce() — Andy Pickle](https://dev.to/pickleat/map-filter-and-reduce-2efb)
...
-  [Mwongozo Kamili wa Ahadi za JavaScript](https://blog.webdevsimplified.com/2021-09/javascript-promises)
...
- [JavaScript ES6 / ES2015 Ahadi — Traversy Media](https://www.youtube.com/watch?v=XJEHuBZQ5dU)
- [Ahadi — Fun Fun Function](https://www.youtube.com/watch?v=2d7s3spWAzo)
- [Kushughulikia Makosa ya Ahadi katika JavaScript — Fun Fun Function](https://www.youtube.com/watch?v=f8IgdnYIwOU)
- [Ahadi Sehemu ya 1 - Mada za JavaScript/ES6 — The Coding Train](https://www.youtube.com/watch?v=QO4NXhWo_NM)
- [Ahadi ya JavaScript kwa Sekunde 100](https://www.youtube.com/watch?v=RvYYCGs45L4)
- [Ahadi ya JavaScript kwa Dakika 9](https://youtu.be/3NjdOtHpcBM)
- [Ahadi za JavaScript kwa Dakika 10 — Web Dev Simplified](https://www.youtube.com/watch?v=DHvZLI7Db8E)
- [Ahadi | Ep 02 Msimu 02 - Namaste JavaScript - Akshay Saini](https://youtu.be/ap-6PPAuK1Y?si=Ri1fopXeYjlrHzpf)
...
-  [Eloquent JavaScript, Toleo la 3: Sura ya 11 - Programu Asynchronous](https://eloquentjavascript.net/11_async.html)
-  [Exploring JS: Programu Asynchronous](http://exploringjs.com/es6/ch_async.html)

### <img  align= center width=40px height=40px src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Kuelewa async/await katika Javascript — Gokul N K](https://hackernoon.com/understanding-async-await-in-javascript-1d81bb079b2c)
-  [JavaScript Asynchronous kutumia async/await — Joy Warugu](https://scotch.io/tutorials/asynchronous-javascript-using-async-await)
-  [JavaScript ya Kisasa Asynchronous na async/await — Flavio Copes](https://flaviocopes.com/javascript-async-await/)
-  [JavaScript Asynchronous: Kutoka Callback Hell hadi Async na Await — Demir Selmanovic](https://www.toptal.com/javascript/asynchronous-javascript-async-await-tutorial)
-  [Javascript — ES8 Utangulizi wa async/await Functions — Ben Garrison](https://medium.com/@_bengarrison/javascript-es8-introducing-async-await-functions-7a471ec7de8a)
-  [Jinsi ya kuepuka async/await hell — Aditya Agarwal](https://medium.freecodecamp.org/avoiding-the-async-await-hell-c77a0fb71c4c)
-  [Kuelewa async await ya JavaScript — Nicolás Bevacqua](https://ponyfoo.com/articles/understanding-javascript-async-await)
-  [JavaScript Async/Await: Serial, Parallel na Complex Flow — TechBrij](https://techbrij.com/javascript-async-await-parallel-sequence)
-  [Kutoka Ahadi za JavaScript hadi Async/Await: kwa nini usumbuke? — Chris Nwamba](https://blog.pusher.com/promises-async-await/)
-  [Udhibiti wa Mtiririko katika JS ya Kisasa: Callbacks hadi Promises hadi Async/Await — Craig Buckler](https://www.sitepoint.com/flow-control-callbacks-promises-async-await/)
-  [Jinsi ya kuboresha msimbo wako wa JavaScript asynchronous na async na await — Indrek Lasn](https://medium.freecodecamp.org/improve-your-asynchronous-javascript-code-with-async-and-await-c02fc3813eda)
-  [Kufanya Fetches Kuwa Rahisi Kwa Async Await — Mickey Sheridan](https://medium.com/@micksheridan.24/making-fetches-easy-with-async-await-8a1246efa1f6)
-  [Sababu 7 Kwa Nini JavaScript Async/Await Ni Bora Kuliko Ahadi za Kawaida — Mostafa Gaafar](https://dev.to/gafi/7-reasons-to-always-use-async-await-over-plain-promises-tutorial-4ej9)
-  [Operesheni za Asynchronous katika JavaScript — Jscrambler](https://dev.to/jscrambler/asynchronous-operations-in-javascript-2p6b)
-  [JavaScript: Ahadi au async-await — Gokul N K](https://medium.com/better-programming/should-i-use-promises-or-async-await-126ab5c98789)
-  [Async / Await: Kutoka Zero hadi Shujaa — Zhi Yuan](https://dev.to/zhiyuanamos/async-await-from-zero-to-hero-a22)
-  [JavaScript Imeonyeshwa: Ahadi & Async/Await — Lydia Hallie](https://dev.to/lydiahallie/javascript-visualized-promises-async-await-5gke)
-  [Kufanya programu ya asynchronous kuwa rahisi na async na await — MDN](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Asynchronous/Async_await)
-  [Mafunzo ya JavaScript Async/Await – Jifunze Callbacks, Ahadi, na Async/Await katika JS kwa Kutengeneza Ice Cream](https://www.freecodecamp.org/news/javascript-async-await-tutorial-learn-callbacks-promises-async-await-by-making-icecream/)
-  [Bora Kuliko Ahadi - JavaScript Async/Await](https://blog.webdevsimplified.com/2021-11/async-await/)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [Kozi ya Ajali ya JavaScript Asynchronous](https://www.youtube.com/watch?v=exBgWAIeIeg)
- [Async + Await — Wes Bos](https://www.youtube.com/watch?v=9YkUCxvaLEk)
- [Asynchrony: Chini ya Hood — Shelley Vohr](https://www.youtube.com/watch?v=SrNQS8J67zc)
- [async/await katika JavaScript - Nini, Kwa Nini na Jinsi — Fun Fun Function](https://www.youtube.com/watch?v=568g8hxJJp4&index=3&list=PL0zVEGEvSaeHJppaRLrqjeTPnCH6)
- [async/await Sehemu ya 1 - Mada za JavaScript/ES8 — The Coding Train](https://www.youtube.com/watch?v=XO77Fib9tSI&index=3&list=PLRqwX-V7Uu6bKLPQvPRNNE65kBL62mVfx)
- [async/await Sehemu ya 2 - Mada za JavaScript/ES8 — The Coding Train](https://www.youtube.com/watch?v=chavThlNz3s&index=4&list=PLRqwX-V7Uu6bKLPQvPRNNE65kBL62mVfx)
- [Mwongozo Kamili wa JS Async & Await ES2017/ES8 — Colt Steele](https://www.youtube.com/watch?v=krAYA4rvbdA)
- [Vidokezo vya kutumia async/await katika JavaScript — James Q Quick](https://www.youtube.com/watch?v=_9vgd9XKlDQ)
- [JavaScript Async Await — Web Dev Simplified](https://www.youtube.com/watch?v=V_Kr9OSfDeU)
- [Ahadi async na await katika javascript — Hitesh Choudhary](https://youtu.be/Gjbr21JLfgg?si=SDCVKr9ONw2GsNdT)
...
### <img align=center width="40" height="40" src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Miundo ya Data katika JavaScript — Thon Ly](https://medium.com/siliconwat/data-structures-in-javascript-1b9aed0ea17c)
-  [Algorithms na Miundo ya Data katika JavaScript — Oleksii Trekhleb](https://itnext.io/algorithms-and-data-structures-in-javascript-a71548f902cb)
-  [Miundo ya Data: Vitu na Arrays ― Chris Nwamba](https://scotch.io/courses/10-need-to-know-javascript-concepts/data-structures-objects-and-arrays)
-  [Miundo ya Data katika JavaScript — Benoit Vallon](http://blog.benoitvallon.com/data-structures-in-javascript/data-structures-in-javascript/)
-  [Kucheza na Miundo ya Data katika Javascript — Anish K.](https://blog.cloudboost.io/playing-with-data-structures-in-javascript-stack-a55ebe50f29d)
-  [Mwongozo Mdogo wa Queue katika JavaScript — Germán Cutraro](https://hackernoon.com/the-little-guide-of-queue-in-javascript-4f67e79260d9)
-  [Algorithms zote zimeandikwa kwa JavaScript katika kitabu 'Algorithms Fourth Edition'](https://github.com/barretlee/algorithms)
-  [Mkusanyiko wa paradigms za sayansi ya kompyuta za kawaida katika JavaScript](https://github.com/nzakas/computer-science-in-javascript)
-  [Mambo yote ambayo hukujua unataka kujua kuhusu miundo ya data](https://github.com/jamiebuilds/itsy-bitsy-data-structures)
-  [Miundo ya Data ya JavaScript: Sehemu 40 za Mfululizo — miku86](https://dev.to/miku86/series/3259)
-  [Miundo ya Data: Kuelewa Graphs — Rachel Hawa](https://medium.com/javascript-in-plain-english/data-structures-understanding-graphs-82509d35e6b5)
-  [Miundo ya Data Njia Mbili: Linked List (Sehemu ya 1) — Freddie Duffield](https://dev.to/freddieduffield/data-structures-two-ways-linked-list-2n61)
-  [Miundo ya Data Njia Mbili: Linked List (Sehemu ya 2) — Freddie Duffield](https://dev.to/freddieduffield/data-structures-two-ways-linked-list-pt2-2i60)
-  [Miundo ya Data ya Graph Imeelezwa katika JavaScript — Adrian Mejia](https://dev.to/amejiarosario/graph-data-structures-for-beginners-5edn)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [Algorithms Katika Javascript | Pata Mafanikio Katika Mahojiano Yako — Eduonix Learning Solutions](https://www.youtube.com/watch?v=H_EBPZgiAas&list=PLDmvslp_VR0zYUSth_8O69p4_cmvZEgLa)
- [Miundo ya Data na Algorithms katika JavaScript — freeCodeCamp](https://www.youtube.com/watch?v=Gj5qBheGOEo&list=PLWKjhJtqVAbkso-IbgiiP48n-O-JQA9PJ)
- [Kujifunza Miundo ya Data na Algorithms za JavaScript: Kupanga — Packt Video](https://www.youtube.com/watch?v=Ymh_AurrMbA)
- [Miundo ya Data ya JavaScript: Kuanza — Academind](https://www.youtube.com/watch?v=41GSinwoMYA&ab_channel=Academind)

**[⬆ Kurudi Juu](#table-of-contents)**

---

## 28. Operesheni Ghali na Big O Notation

### <img align= center width=40px height=40px src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Big O Notation katika Javascript — César Antón Dorantes](https://medium.com/cesars-tech-insights/big-o-notation-javascript-25c79f50b19b)
-  [Ugumu wa Muda/Big O Notation — Tim Roberts](https://medium.com/javascript-scene/time-complexity-big-o-notation-1a4310c3ee4b)
-  [Big O katika JavaScript — Gabriela Medina](https://medium.com/@gmedina229/big-o-in-javascript-36ff67766051)
-  [Big O Search Algorithms katika JavaScript — Bradley Braithwaite](https://www.bradoncode.com/blog/2012/04/big-o-algorithm-examples-in-javascript.html)
-  [Algorithms kwa lugha rahisi: ugumu wa muda na Big-O Notation — Michael Olorunnisola](https://medium.freecodecamp.org/time-is-complex-but-priceless-f0abd015063c)
-  [Utangulizi wa Big O Notation — Joseph Trettevik](https://dev.to/lofiandcode/an-introduction-to-big-o-notation-210o)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [JavaScript: Utangulizi wa Big O Notation na Runtime ya Function — Eric Traub](https://www.youtube.com/watch?v=HgA5VOFan5E)
- [Big O Muhimu kwa Watengenezaji wa JavaScript — Dave Smith](https://www.youtube.com/watch?v=KatlvCFHPRo)
- [Big O Notation - Uchambuzi wa Ugumu wa Muda — WebTunings](https://www.youtube.com/watch?v=ALl86xJiTD8)
- [Jifunze Big O Notation Kwa Dakika 12 - Web Dev Simplified](https://www.youtube.com/watch?v=itn09C2ZB9Y)
- [Algorithms za JavaScript: Big-O Notation - Codevolution](https://www.youtube.com/watch?v=3yUuo7TqMW8)
- [Kozi ya Ajali ya Algorithms za JavaScript: Jifunze Algorithms & "Big O" kutoka Msingi! - Academind](https://www.youtube.com/watch?v=JgWm6sQwS_I)
- [Big O Notation - Miundo ya Data na Algorithms katika Javascript - RoadSideCoder](https://www.youtube.com/watch?v=LaexPVi1VRE)
...
-  [Miundo ya Data na Algorithms kutumia ES6](https://github.com/Crizstian/data-structure-and-algorithms-with-ES6)
-  [Algorithms na miundo ya data iliyotekelezwa katika JavaScript na maelezo na viungo vya kusoma zaidi](https://github.com/trekhleb/javascript-algorithms)
-  [JS: Algorithm ya Mahojiano](http://www.thatjsdude.com/interview/js1.html)
-  [Algorithms katika JavaScript — Thon Ly](https://medium.com/siliconwat/algorithms-in-javascript-b0bed68f4038)
-  [Vitu vya JavaScript, Mabano ya Mraba na Algorithms — Dmitri Grabov](https://medium.freecodecamp.org/javascript-objects-square-brackets-and-algorithms-e9a2916dc158)
-  [Sheria ya Atwood ikitumika kwa CS101 - Algorithms za kawaida na miundo ya data iliyotekelezwa katika JavaScript](https://github.com/felipernb/algorithms.js)
-  [Maktaba ya Miundo ya Data na Algorithms katika JavaScript](https://github.com/yangshun/lago)
-  [Mkusanyiko wa algorithms za sayansi ya kompyuta na miundo ya data iliyoandikwa katika JavaScript](https://github.com/idosela/algorithms-in-javascript)
-  [Algorithms na Miundo ya Data katika JavaScript — Oleksii Trekhleb](https://dev.to/trekhleb/algorithms-and-data-structures-in-javascript-49i3)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- 🎥 [Algorithms za JavaScript - Codevolution](https://www.youtube.com/playlist?list=PLC3y8-rFHvwiRYB4-HHKHblh3_bQNJTMa)
- 🎥 [Programu ya Dynamic - Jifunze Kutatua Shida za Algorithmic & Changamoto za Coding - FreeCodeCamp](https://www.youtube.com/watch?v=oBt53YbR9Kk&t=1021s)
- 🎥 [Miundo ya Data na Algorithms katika Javascript | DSA na JS - RoadsideCoder](https://www.youtube.com/playlist?list=PLKhlp2qtUcSZtJefDThsXcsAbRBCSTgW4)
- 🎥 [Algorithms + Miundo ya Data ya Javascript - KodingKevin](https://www.youtube.com/playlist?list=PLn2ipk-jqgZiAHiA70hOxAj8RMUeqYNK3)
- 🎥 [Miundo ya Data ya JavaScript: Kuanza - Academind](https://www.youtube.com/watch?v=41GSinwoMYA)
- 🎥 [Algorithms na Miundo ya Data - The Coding Train (Daniel Shiffman)](https://www.youtube.com/playlist?list=PLRqwX-V7Uu6ZiZxtDDRCi6uhfTH4FilpH)

**[⬆ Kurudi Juu](#table-of-contents)**

---

## 30. Urithi, Polymorphism na Matumizi ya Tena ya Msimbo

### Marejeleo

-  [Urithi katika JavaScript — MDN](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/Inheritance)
-  [Urithi wa Darasa, super — JavaScript.Info](https://javascript.info/class-inheritance)

### <img  align= center width=40px height=40px src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Urithi katika JavaScript — Rupesh Mishra](https://hackernoon.com/inheritance-in-javascript-21d2b82ffa6f)
-  [Urithi Rahisi na JavaScript — David Catuhe](https://www.sitepoint.com/simple-inheritance-javascript/)
-  [JavaScript — Mifumo ya urithi, delegation na Uunganishaji wa Vitu — NC Patro](https://codeburst.io/javascript-inheritance-25fe61ab9f85)
-  [JavaScript ya Kielelezo: Polymorphism na mifano — Knoldus Blogs](https://blog.knoldus.com/object-oriented-javascript-polymorphism-with-examples/)
-  [Programu Kama Proteus — Mwongozo wa mwanzoni wa polymorphism katika Javascript — Sam Galson](https://medium.com/yld-blog/program-like-proteus-a-beginners-guide-to-polymorphism-in-javascript-867bea7c8be2)
-  [JavaScript ya Kielelezo: Uchunguzi wa Kina wa Madarasa ya ES6 — Jeff Mott](https://www.sitepoint.com/object-oriented-javascript-deep-dive-es6-classes/)
-  [Kufungua Nguvu ya Polymorphism katika JavaScript: Uchunguzi wa Kina](https://prototypr.io/post/unlocking-the-power-of-polymorphism-in-javascript-a-deep-dive)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [Urithi katika JavaScript — kudvenkat](https://www.youtube.com/watch?v=yXlFR81tDBM)
- [Madarasa ya ES6 na Urithi katika JavaScript — Traversy Media](https://www.youtube.com/watch?v=RBLIm5LMrmc)
- [Polymorphism katika JavaScript — kudvenkat](https://www.youtube.com/watch?v=zdovG9cuEBA)

**[⬆ Kurudi Juu](#table-of-contents)**

---

## 31. Mifumo ya Ubunifu

### Vitabu

-  [Kujifunza Mifumo ya Ubunifu ya JavaScript — Addy Osmani](https://addyosmani.com/resources/essentialjsdesignpatterns/book/)
-  [Mifumo ya Ubunifu ya Pro JavaScript — Ross Harmes na Dustin Diaz](https://pepa.holla.cz/wp-content/uploads/2016/08/Pro-JavaScript-Design-Patterns.pdf)

### <img  align= center width=40px height=40px src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Mifumo ya Ubunifu ya JavaScript – Imeelezwa kwa Mifano — Germán Cocca](https://www.freecodecamp.org/news/javascript-design-patterns-explained/)
-  [Mifumo 4 ya Ubunifu ya JavaScript Unayopaswa Kujua — Devan Patel](https://scotch.io/bar-talk/4-javascript-design-patterns-you-should-know)
-  [Mifumo ya Ubunifu ya JavaScript – Mwongozo wa Mwanzoni wa Maendeleo ya Wavuti ya Simu — Soumyajit Pathak](https://medium.com/beginners-guide-to-mobile-web-development/javascript-design-patterns-25f0faaaa15)
-  [Mifumo ya Ubunifu ya JavaScript — Akash Pal](https://medium.com/front-end-hacking/javascript-design-patterns-ed9d4c144c81)
-  [Mifumo yote 23 (GoF) iliyotekelezwa katika Javascript — Felipe Beline](https://github.com/fbeline/Design-Patterns-JS)
-  [Nguvu ya Mfano wa Moduli katika JavaScript — jsmanifest](https://medium.com/better-programming/the-power-of-the-module-pattern-in-javascript-3c73f7cd10e8)
-  [Mifumo ya Ubunifu kwa Watengenezaji kutumia JavaScript pt. I — Oliver Mensah](https://dev.to/omensah/design-patterns-for-developers-using-javascript----part-one--b3e)
-  [Mifumo ya Ubunifu kwa Watengenezaji kutumia JavaScript pt. II — Oliver Mensah](https://dev.to/omensah/design-patterns-for-developers-using-javascript---part-two--3p39)
-  [Mifumo ya ubunifu katika maendeleo ya kisasa ya JavaScript](https://levelup.gitconnected.com/design-patterns-in-modern-javascript-development-ec84d8be06ca)
-  [Kuelewa Mifumo ya Ubunifu: Iterator kutumia mitandao ya kijamii ya Dev.to na Medium! — Carlos Caballero](https://dev.to/carlillo/understanding-design-patterns-iterator-using-dev-to-and-medium-social-networks-3bdd)
-  [Mfumo wa Ubunifu wa JavaScript - Mfano wa Kiwanda — KristijanFištrek](https://dev.to/kristijanfistrek/javascript-design-patterns-factory-pattern-562p)
-  [Mfumo wa Ubunifu wa JavaScript — Mfano wa Moduli - Mfano wa Kiwanda — Moon](https://medium.com/javascript-in-plain-english/javascript-design-pattern-module-pattern-555737eccecd)
-  [Mifumo ya Ubunifu: Kitu Null - Carlos Caballero](https://medium.com/better-programming/design-patterns-null-object-5ee839e37892)
-  [Mfumo wa Mkakati - Francesco Ciulla](https://dev.to/francescoxx/strategy-pattern-5oh)
-  [Mfumo wa Adapter - Francesco Ciulla](https://dev.to/francescoxx/adapter-pattern-5bjk)
-  [Nguvu ya Mfano wa Composite katika JavaScript - jsmanifest](https://dev.to/jsmanifest/the-power-of-composite-pattern-in-javascript-2732)
-  [Kutetea Uandishi wa Msimbo wa Kujihami - Adam Nathaniel Davis](https://dev.to/bytebodger/in-defense-of-defensive-programming-k45)
-  [Warsha ya Mifumo ya JavaScript — Lydia Hallie](https://javascriptpatterns.vercel.app/patterns)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [Mifumo ya Ubunifu ya JavaScript — Udacity](https://www.udacity.com/course/javascript-design-patterns--ud989)
- [Mifumo ya JavaScript kwa 2017 — Scott Allen](https://www.youtube.com/watch?v=hO7mzO83N1Q)

**[⬆ Kurudi Juu](#table-of-contents)**

---

## 32. Matumizi ya Sehemu, Currying, Compose na Pipe

### Vitabu

-  [Functional-Light JavaScript: Sura ya 3 - Kusimamia Ingizo la Kazi — Kyle Simpson](https://github.com/getify/Functional-Light-JS/blob/master/manuscript/ch3.md)

### <img  align= center width=40px height=40px src="https://cdn-icons-png.flaticon.com/512/1945/1945940.png"> Makala

-  [Muundo na Currying Urembo katika JavaScript — Pragyan Das](https://medium.com/@pragyan88/writing-middleware-composition-and-currying-elegance-in-javascript-8b15c98a541b)
-  [JavaScript ya Kazi: Muundo wa Kazi kwa Matumizi ya Kila Siku — Joel Thoms](https://hackernoon.com/javascript-functional-composition-for-every-day-use-22421ef65a10)
-  [Muundo wa Kazi: compose() na pipe() — Anton Paras](https://medium.com/@acparas/what-i-learned-today-july-2-2017-ab9a46dbf85f)
-  [Kwa Nini Hipsters Wanaunda Kila Kitu: Muundo wa Kazi Katika JavaScript — A. Sharif](http://busypeoples.github.io/post/functional-composing-javascript/)
-  [Utangulizi Mpole kwa JavaScript ya Kazi pt III: Kazi za kutengeneza kazi — James Sinclair](https://jrsinclair.com/articles/2016/gentle-introduction-to-functional-javascript-functions/)
-  [Curry Na Compose (kwa nini unapaswa kutumia kitu kama ramda katika msimbo wako) — jsanchesleao](https://jsleao.wordpress.com/2015/02/22/curry-and-compose-why-you-should-be-using-something-like-ramda-in-your-code/)
-  [Muundo wa Kazi katika JavaScript na Pipe — Andy Van Slaars](https://vanslaars.io/post/create-pipe-function/)
-  [JavaScript ya Kazi ya Kivitendo na Ramda — Andrew D'Amelio, Yuri Takhteyev](https://developer.telerik.com/featured/practical-functional-javascript-ramda/)
-  [Urembo katika Matumizi ya Sehemu, Currying, na Muundo wa Kazi — Joel Thoms](https://hackernoon.com/the-beauty-in-partial-application-currying-and-function-composition-d885bdf0d574)
-  [Curry au Matumizi ya Sehemu? — Eric Elliott](https://medium.com/javascript-scene/curry-or-partial-application-8150044c78b8)
-  [Matumizi ya Sehemu katika JavaScript — Ben Alman](http://benalman.com/news/2012/09/partial-application-in-javascript/)
-  [Matumizi ya Sehemu ya Kazi — Functional Reactive Ninja](https://hackernoon.com/partial-application-of-functions-dbe7d9b80760)
-  [Currying vs Matumizi ya Sehemu — Deepak Gupta](https://towardsdatascience.com/javascript-currying-vs-partial-application-4db5b2442be8)
-  [Matumizi ya Sehemu katika ECMAScript 2015 — Ragan Wald](http://raganwald.com/2015/04/01/partial-application.html)
-  [Kwa hivyo Unataka Kuwa Mprogramu wa Kazi pt. I — Charles Scalfani](https://medium.com/@cscalfani/so-you-want-to-be-a-functional-programmer-part-1-1f15e387e536)
-  [Kwa hivyo Unataka Kuwa Mprogramu wa Kazi pt. II — Charles Scalfani](https://medium.com/@cscalfani/so-you-want-to-be-a-functional-programmer-part-2-7005682cec4a)
-  [Kwa hivyo Unataka Kuwa Mprogramu wa Kazi pt. III — Charles Scalfani](https://medium.com/@cscalfani/so-you-want-to-be-a-functional-programmer-part-3-1b0fd14eb1a7)
-  [Kwa hivyo Unataka Kuwa Mprogramu wa Kazi pt. IV — Charles Scalfani](https://medium.com/@cscalfani/so-you-want-to-be-a-functional-programmer-part-4-18fbe3ea9e49)
-  [Kwa hivyo Unataka Kuwa Mprogramu wa Kazi pt. V — Charles Scalfani](https://medium.com/@cscalfani/so-you-want-to-be-a-functional-programmer-part-5-c70adc9cf56a)
-  [Utangulizi wa kanuni za msingi za Programu ya Kazi — TK](https://medium.freecodecamp.org/an-introduction-to-the-basic-principles-of-functional-programming-a2c2a15c84)
-  [Mafunzo ya Msingi ya Programu ya Kazi katika Javascript — TK](https://medium.com/the-renaissance-developer/concepts-of-functional-programming-in-javascript-6bc84220d2aa)
-  [Utangulizi wa Mtindo wa Programu ya Kazi katika JavaScript — Mwalimu wa JavaScript](https://medium.freecodecamp.org/an-introduction-to-functional-programming-style-in-javascript-71fcc050f064)
-  [Mwongozo wa Kivitendo wa Kuandika JavaScript ya Kazi Zaidi — Nadeesha Cabral](https://medium.freecodecamp.org/a-practical-guide-to-writing-more-functional-javascript-db49409f71)
-  [Ufafanuzi Rahisi wa Muundo wa Kazi katika JavaScript — Ben Lesh](https://dev.to/benlesh/a-simple-explanation-of-functional-pipe-in-javascript-2hbj)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- [Compose vs Pipe: Programu ya Kazi katika JavaScript — Chyld Studios](https://www.youtube.com/watch?v=Wl2ejJOqHUU)
- [JavaScript Functional Programing: Compose — Theodore Anderson](https://www.youtube.com/watch?v=jigHxo9YR30)
- [Muundo wa Kazi - JavaScript ya Kazi — NWCalvank](https://www.youtube.com/watch?v=mth5WpEc4Qs)
- [Muundo wa Kazi wa JavaScript Umeelezwa — Theodore Anderson](https://www.youtube.com/watch?v=Uam37AlzPYw)
- [Tufanye programu na muundo wa kazi — Fun Fun Function](https://www.youtube.com/watch?v=VGB9HbL1GHk)
- [Matumizi ya Sehemu dhidi ya Currying — NWCalvank](https://www.youtube.com/watch?v=DzLkRsUN2vE)
- [Matumizi ya Sehemu ya JavaScript — Theodore Anderson](https://www.youtube.com/watch?v=jkebgHEcvac)
- [Njia za call, apply na bind katika JavaScript](https://www.youtube.com/watch?v=75W8UPQ5l7k&t=261s)
...
-  [Msimbo Safi Umeelezwa – Utangulizi wa Kivitendo wa Kuandika Msimbo Safi kwa Kompyuta — freeCodeCamp](https://www.freecodecamp.org/news/clean-coding-for-beginners/)
-  [Mafunzo ya Msimbo Safi kwa JavaScript — Ryan McDermott](https://github.com/ryanmcdermott/clean-code-javascript)
-  [Mazoezi ya Msimbo Safi: Jinsi ya Kuandika Msimbo Safi — Tirth Bodawala](https://www.atyantik.com/clean-code-practices-javascript/)
-  [Vigezo vya Kazi katika Msimbo Safi wa JavaScript — Kevin Peters](https://medium.com/@kevin_peters/function-parameters-in-javascript-clean-code-4caac109159b)
-  [Kuweka Msimbo Wako Safi — Samuel James](https://codeburst.io/keeping-your-code-clean-d30bcffd1a10)
-  [Mazoezi Bora ya Kutumia Sintaksia ya Kisasa ya JavaScript — M. David Green](https://www.sitepoint.com/modern-javascript-best-practices/)
-  [Mazoezi Bora kwa Maendeleo ya Node/Web ya Msalaba - Jimmy Wärting](https://github.com/cross-js/cross-js)
-  [Kuandika Msimbo Safi - Dylan Paulus](https://dev.to/ganderzz/on-writing-clean-code-57cm)
-  [Kuandika Msimbo Safi na Mazoezi ya Kiprogramu - Nityesh Agarwal](https://dev.to/nityeshaga/writing-clean-code-and-the-practice-of-programming-actionable-advice-for-beginners-5f0k)
-  [Msimbo Safi, Msimbo Chafu, Msimbo wa Binadamu - Daniel Irvine](https://dev.to/d_ir/clean-code-dirty-code-human-code-6nm)
-  [Njia za Kivitendo za Kuandika JavaScript Bora - Ryland G](https://dev.to/taillogs/practical-ways-to-write-better-javascript-26d4)
-  [Kanuni za Lazima Kujua za Msimbo Safi - Kesk kwenye Medium](https://medium.com/swlh/the-must-know-clean-code-principles-1371a14a2e75)
-  [Kitabu cha Msimbo Safi - Robert C Martin](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882/)
-  [Jinsi ya Kutumia Destructuring katika JavaScript Kuandika Msimbo Safi, Nguvu Zaidi - freecodecamp](https://www.freecodecamp.org/news/how-to-use-destructuring-in-javascript-to-write-cleaner-more-powerful-code-9d1b38794050/)
-  [Kuandika Msimbo Safi Kutumia JavaScript Object Destructuring - Asel Siriwardena](https://betterprogramming.pub/write-clean-code-using-javascript-object-destructuring-3551302130e7)

### <img align=center width="40" height="40" src="https://img.icons8.com/dusk/64/video.png" alt="video"/>  Video

- 🎥 [Vidokezo vya Pro vya JavaScript - Andika Hivi, Sio Hivyo](https://www.youtube.com/watch?v=Mus_vwhTCq0)
- 🎥 [Orodha ya Msimbo Safi - Beau anafundisha](https://www.youtube.com/watch?v=b9c5GmmS7ks&list=PLWKjhJtqVAbkK24EaPurzMq0-kw5U9pJh&index=1)
- 🎥 [Mazoezi Bora ya JavaScript na Mikataba ya Kuandika Msimbo Safi](https://youtu.be/RMN_bkZ1KM0?si=Ssg3cNZ_DB7CIwKQ)
- 🎥 [Msimbo Safi wa JavaScript](https://youtu.be/vPXzVNmCPg4?si=QR1k4E6Zx5H4mfcs)
- 🎥 [Vidokezo vya Kujifunza Jinsi ya Kuandika Msimbo](https://www.youtube.com/watch?v=0wHyoBPc6zs)

**[⬆ Kurudi Juu](#table-of-contents)**

## <img align= center width=50px height=50px src="https://moein.video/wp-content/uploads/2022/05/license-GIF-Certificate-Royalty-Free-Animated-Icon-350px-after-effects-project.gif"> Leseni <a id = "License"></a>
Programu hii imesajiliwa chini ya Leseni ya MIT, Tazama [Leseni](https://github.com/leonardomso/33-js-concepts/blob/master/LICENSE) kwa maelezo zaidi ©Leonardo Maldonado.
